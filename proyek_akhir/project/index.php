   ...
   <div class="swiper reviews-slider">
      ...
      <div class="swiper-wrapper">
         <div class="swiper-slide box">
            ...
            <h3>Syahrini</h3>
            <p>Dekat dengan bandara, fasilitas lengkap, staf ramah dan helpfull, makanannya juga enak-enak.</p>
         </div>
         <div class="swiper-slide box">
            <img src="images/pic-2.jpg" alt="">
            <h3>Mahalini</h3>
            <p>Hotel yang sangat lengkap fasilitasnya, dan lokasi yang strategis dekat dengan super market dan transportasi umum.</p>
         </div>
         <div class="swiper-slide box">
            <img src="images/pic-3.jpg" alt="">
            <h3>Jusuf Hamka</h3>
            <p>Lokasinya strategis, dekat dengan lokasi-lokasi tujuan saya. saya suka kamar mandinya yang luas, terang dan bersih.</p>
         </div>
         <div class="swiper-slide box">
            <img src="images/pic-4.jpg" alt="">
            <h3>Ariel Tatum</h3>
            <p>Staf ramah, ruangan bersih, pilihan makanan saat sarapan cukup variatif, semua fasilitas berfungsi dengan baik.</p>
         </div>
         <div class="swiper-slide box">
            <img src="images/pic-5.jpg" alt="">
            <h3>Hotman Paris</h3>
            <p>Staff yang ramah, lokasi yang sangat strategis, kamar yang bersih dan nyaman, tersedia kopi dan teh 24 jam di lobby.</p>
         </div>
         <div class="swiper-slide box">
            <img src="images/pic-6.jpg" alt="">
            <h3>Najwa Shihab</h3>
            <p>Hotel yang bagus untuk menginap bareng keluarga, banyak spot foto, ada ruang main anak, dan makanannya enak-enak banget.</p>
         </div>
      </div>
